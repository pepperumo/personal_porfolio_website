...
class ConversationalAIService:
    ...
    def load_model(self):
        ...
        try:
            ...
            print(f"  - use_openai: {self.settings.use_openai}")
            print(f"  - openai_api_key: {'SET' if self.settings.openai_api_key else 'NOT SET'}")
            print(f"  - OPENAI_AVAILABLE: {OPENAI_AVAILABLE}")
            print(f"  - openai_model: {self.settings.openai_model}")
            ...
            if self.settings.use_openai and self.settings.openai_api_key and OPENAI_AVAILABLE:
                ...
                print(f"❌ OpenAI requested but missing requirements:")
            ...
            print(f"🔄 Falling back to local model: {self.chat_model_name}")
