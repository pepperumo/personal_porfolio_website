...
class Settings(BaseSettings):
    ...
    hf_chat_model_name: str = Field(default="microsoft/DialoGPT-medium", env="HF_CHAT_MODEL_NAME")  # Better conversational model
    ...
    use_openai: bool = Field(default=True, env="USE_OPENAI")  # Flag to switch to OpenAI
